							...
							<form action="process_register.php" method="POST">
								...
								<tr>
									...
									<select style="width: 195px;" name="city">
										...
										<option>Sofia <option>Plovdiv <option>Varna <option>Bourgas <option>Rousse <option>Stara Zagora <option>Pleven <option>Sliven <option>Dobritch <option>Shumen <option>Pernik <option>Haskovo <option>Yambol
									</select>
								</tr>
